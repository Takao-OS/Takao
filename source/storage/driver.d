...
/// Init the storage subsystem.
void initStorageSubsystem() {
...
/// Read a 4 Kbytes block from a drive.
/// Params:
///     drive  = Drive to read, not null.
///     output = Where to write the read 4K block (must be 4K lol).
///     offset = Offset of the 4k block.
/// Returns: Pointer to read data, or `null` in failure, this data is not to be modified.
...
/// Params:
///     drive  = Drive to read, not null.
///     data   = Data to write (must be 4K lol).
///     offset = Offset of the 4k block.
